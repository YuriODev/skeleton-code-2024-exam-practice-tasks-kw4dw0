...
class Puzzle():
    ...
    def AttemptPuzzle(self):
        Finished = False
        Lever = 0 ###
        RemoveBlockedCell = False ###
        while not Finished:
            self.DisplayPuzzle()
            print("Current score: " + str(self.__Score))
            #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
            if Lever > 0:
                choice = input("Do you want to remove a Blocked Cell? Press enter to ignore\n")
                if len(choice) == 0:
                    pass
                else:
                    RemoveBlockedCell = True
            #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
            Row = -1
            Valid = False
            while not Valid:
            ...
            if RemoveBlockedCell:
                ...
                if CurrentCell.GetSymbol() == "@":
                    print("kegegkj")
                    index = self.__Grid.index(CurrentCell)
