...
class Puzzle():
    def __init__(self, *args):
        ...
        if len(args) == 1:
            ...
            for i in range(5):
                num = 0
                while num == 0 or self.__Grid[num].GetSymbol() is not "-":
                    num = random.randrange(1, self.__GridSize * self.__GridSize + 1)
                self.__Grid[num] = DoublePointCell()
                ...
                try:
                    ...
                    for P in self.__AllowedPatterns:
                        ...
                        if P.MatchesPattern(PatternString, CurrentSymbol):
                            ...
                            for i in range(3):
                                for j in range(3):
                                    if self.__GetCell(StartRow - i, StartColumn + j).IsDouble() is True:
                                        Double = True
                                        print("Double Found")
