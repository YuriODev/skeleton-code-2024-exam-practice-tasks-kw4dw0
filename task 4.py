...
class Puzzle():
    def __init__(self, *args):
        ...
        if len(args) == 1:
            ...
            QPattern = Pattern("Q", "QQ**Q**QQ", random.randrange(1, 4)) #random.randrange(1, 3)
            """
            ...
            XPattern = Pattern("X", "X*X*X*X*X", random.randrange(1, 4)) #random.randrange(1, 3)
            self.__AllowedPatterns.append(XPattern)
            self.__AllowedSymbols.append("X")
            TPattern = Pattern("T", "TTT**T**T", random.randrange(1, 4)) #random.randrange(1, 3)
...
class Pattern():
    ...
    def MatchesPattern(self, PatternString, SymbolPlaced):
        ...
        if self.PatternCount == 0:
            print(f"Limit for {self.__Symbol} pattern has been reached.")
            return False
        #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    ...
    def OutPutPatternCount(self):
        print(f"{self.__Symbol} pattern can be placed {self.PatternCount} more times.")
