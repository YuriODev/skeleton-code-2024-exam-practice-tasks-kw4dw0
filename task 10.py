...
class Puzzle():
    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            self.DisplayPuzzle()
            print(f"You have {self.__SymbolsLeft} tries left")
            ...
            if CurrentCell == None:
                ...
                if CurrentCell.CheckSymbolAllowed(Symbol):
                    if CurrentCell.CheckSymbolAllowed(CurrentCell.GetSymbol()) is False:
                        print("Cannot overwrite pre-exisitng pattern.")
                    else:
                    ...
                    print("A pattern has been created in this area using this symbol")
    ...
    def __GetCell(self, Row, Column):
        #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
        index = [x for x in range(1, self.__GridSize + 1)]
        if Row not in index or Column not in index:
            return None
        #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
